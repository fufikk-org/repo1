...
report 70111 "COL Calc. Plan - Plan. Wksh."
{
    Caption = 'COL Calc. Plan - Plan. Wksh.';
    ProcessingOnly = true;
    ...
    dataset
    {
        dataitem(SKUds; "Stockkeeping Unit")
        {
            DataItemTableView = sorting("COL Low-Level Code");
            dataitem(Item; Item)
            {
                ...
                begin
                    ...
                    Item.SetFilter("Variant Filter", SKUds."Variant Code");

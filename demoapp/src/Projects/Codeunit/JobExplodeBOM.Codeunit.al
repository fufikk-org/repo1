...
codeunit 70169 "COL Job-Explode BOM"
{
    ...
    begin
        ...
        repeat
            ...
            ToJobPlanningLine.Validate(Quantity, (FromBOMComp."Quantity per" * JobPlanningLine.Quantity));
    ...
    begin
        ...
        if localItem.Get(FromBOMComp."No.") then
            case localItem."Replenishment System" of
                localItem."Replenishment System"::Assembly:
                    ToJobPlanningLine."Replenishment Type PGS" := ToJobPlanningLine."Replenishment Type PGS"::"Assembly Order";
                localItem."Replenishment System"::Purchase:
                    ToJobPlanningLine."Replenishment Type PGS" := ToJobPlanningLine."Replenishment Type PGS"::"Purchase Order";
                localItem."Replenishment System"::"Prod. Order":
                    ToJobPlanningLine."Replenishment Type PGS" := ToJobPlanningLine."Replenishment Type PGS"::"Production Order";
            end;

        ToJobPlanningLine.COLSetCurrFieldNo(ToJobPlanningLine.FieldNo("No."));
        ...
        ToJobPlanningLine.Validate("Unit Cost", 0);
        ToJobPlanningLine.Validate("Unit Price", 0);
        ToJobPlanningLine.Validate("Customer No. PGS", JobPlanningLine."Customer No. PGS");
    end;
    ...
    begin
        ...
        ToJobPlanningLine.Type := ToJobPlanningLine.Type::Item;
        ToJobPlanningLine.Validate("No.", SalesReceivablesSetup."COL Assembly Explode Item No.");
        ...
        ToJobPlanningLine."BOM Item No." := BOMItemNo;
        ToJobPlanningLine.Validate("Planning Date", FromJobPlanningLine."Planning Date");
        ToJobPlanningLine.Validate("Planned Delivery Date", FromJobPlanningLine."Planned Delivery Date");
        ToJobPlanningLine.Validate("Quantity", FromJobPlanningLine."Quantity");
        ...
        ToJobPlanningLine.Validate("Customer No. PGS", FromJobPlanningLine."Customer No. PGS");
        ToJobPlanningLine.Validate("VAT %", FromJobPlanningLine."VAT %");
        ToJobPlanningLine.Validate("VAT Unit Price", FromJobPlanningLine."VAT Unit Price");

...
pageextension 70125 "COL Posted Sales Shipment" extends "Posted Sales Shipment"
{
    layout
    {
        addlast(General)
    ...
    actions
    {
        addlast("&Shipment")
        {
            action("COL Packages")
            {
                ...
                RunPageLink = "Table Id" = const(Database::"Sales Shipment Header"), "Document No." = field("No.");
            }
        }

        addlast(Category_Category5) // shipment
        {
